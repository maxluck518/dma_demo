create_project FiveTupleDemo FiveTupleDemo_vivado/FiveTupleDemo -part xcvu9p-flgc2104-2-e
add_files -scan_for_includes ./
update_compile_order -fileset sources_1
update_compile_order -fileset sources_1
set_property top FiveTupleDemo [current_fileset]
update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
ipx::package_project -root_dir FiveTupleDemo_vivado/FiveTupleDemo/FiveTupleDemo.srcs/sources_1/imports/FiveTupleDemo -vendor xilinx.com -library user -taxonomy /UserIP
set_property library sdnet [ipx::current_core]
set_property name FiveTupleDemo [ipx::current_core]
set_property display_name FiveTupleDemo_v1_0 [ipx::current_core]
set_property description FiveTupleDemo_v1_0 [ipx::current_core]
...
set_property value packet_in_instream:packet_out_outstream [ipx::get_bus_parameters ASSOCIATED_BUSIF -of_objects [ipx::get_bus_interfaces clk_line -of_objects [ipx::current_core]]] 
...
ipx::update_checksums [ipx::current_core]
ipx::save_core [ipx::current_core]
update_ip_catalog -rebuild -repo_path FiveTupleDemo_vivado/FiveTupleDemo/FiveTupleDemo.srcs/sources_1/imports/FiveTupleDemo
